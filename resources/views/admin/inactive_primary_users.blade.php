        ...
        <div class="row">
          ...
          <div class="col-sm-5">
            <label>
              ...
              <button type="submit" class="btn btn-primary input-sm" placeholder="" aria-controls="example1" id="btnNotify">
                Notify
              </button>
              <button type="submit" class="btn btn-info input-sm" placeholder="" aria-controls="example1" id="btnAutomation">
                Auto Notify
              </button>
          ...
          <div class="col-sm-3">
            <div id="example1_filter" class="dataTables_filter">
              ...
              <form action="" method="get">
                <label><select class="form-control input-sm" name="days">
                ...
                <label>
                  <button type="submit" class="btn btn-info input-sm" placeholder="" aria-controls="example1">
                    Search
                  </button>
                </label>
              </form>
