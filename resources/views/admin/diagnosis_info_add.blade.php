...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Diagnosis Info Add
        <a href="/diagnosis_info" role='button' class="btn btn-success" style="margin-left:20px"> &nbsp; Diagnosis List &nbsp;</a>
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="col-sm-6 col-md-push-3">
          <form role="form" id="addForm" action="" method="post" name="addPackageEntity">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="diagnosis_name" name="diagnosis_name" value="" placeholder="Diagnosis Name" required>
            </div>
            <div class="form-group">
