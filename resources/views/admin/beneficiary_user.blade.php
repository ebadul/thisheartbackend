        ...
        <tbody>
          <?php if ($beneficiary_accounts) : ?>
            ...
            <tr role="row" class="odd">
              ...
              <td class="text-center">
                <a href="{{url("/delete_beneficiary_user/".$row['id'])}}" class="btn btn-block btn-danger" role="button" onclick="return confirm('Do you want to delete beneficiary user data')" alt="Delete Beneficiary User">
                  Delete</a>
              </td>
            </tr>
            @endforeach
