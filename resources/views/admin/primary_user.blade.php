...
<div class="wrapper">
                ...
                <?php if ($primary_accounts) : ?>
                  ...
                  <tr role="row" class="odd">
                    ...
                    <td class="text-center">
                      <input class="activeSts checkbox" user-id="{{$row['id']}}" type="checkbox" {{$row["active"] ? "checked" : ""}} data-toggle="toggle" data-onstyle="success" data-offstyle="danger" data-on="Active" data-off="InActive" />
                    </td>
                    <td class="text-center">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2014-2019 <a href="https://thisheart.co"> This Heart Admin</a>.</strong> All rights
    reserved.
  </footer>
